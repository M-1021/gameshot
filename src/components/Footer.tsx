export default function Footer() {
  return (
    <footer className="border-t border-zinc-200/50 px-6 py-10 dark:border-zinc-800/50">
      <div className="mx-auto flex max-w-7xl flex-col items-center justify-between gap-4 text-center md:flex-row md:text-left">
        ...
        <div className="flex items-center gap-5">
          ...
          <a href="https://github.com/M-1021/gameshot" target="_blank" rel="noopener noreferrer"
            className="text-zinc-400 transition-colors hover:text-zinc-600 dark:text-zinc-500 dark:hover:text-zinc-300"
          >
            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
